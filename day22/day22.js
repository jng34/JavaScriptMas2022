...
let tableArr = getReadyTables();

function displayTables(tableArr) {
  return tableArr.map(tableNum => `<div class="table">${tableNum}</div>`).join('')
}

let tables = document.getElementById("tables");
tables.innerHTML = displayTables(tableArr)